...
export function releaseJump(r){if(r.jumpHeld&&r.jumpAge<HOLD_TIME&&r.vy>0&&r.y<LOW_HEIGHT)r.vy=Math.min(r.vy,Math.sqrt(Math.max(0,2*GRAVITY*(LOW_HEIGHT-r.y))));r.jumpHeld=false}
